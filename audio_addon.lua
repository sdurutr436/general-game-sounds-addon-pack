...
local CUES = {
  -- Ultrakill
    ...
    ["ultrakill\\gab_divinejustice.wav"] = "Gabriel: Divine Justice",
    ["ultrakill\\gab_youneedmorepower.wav"] = "Gabriel: You Need More Power",

    -- Minos Prime
    ["ultrakill\\mp_crush.ogg"] = "Minos Prime: Crush",
    ["ultrakill\\mp_intro_long.wav"] = "Minos Prime: Introduction Long",
    ...
    ["ultrakill\\mp_useless.wav"] = "Minos Prime: Useless",

    -- Sisyphus Prime
    ["ultrakill\\sp_begone.wav"] = "Sisyphus Prime: Begone",
    ["ultrakill\\sp_keepthemcoming.wav"] = "Sisyphus Prime: Keep Them Coming",
    ["ultrakill\\sp_nicetry.wav"] = "Sisyphus Prime: Nice Try",
    ["ultrakill\\sp_thiswillhurt.wav"] = "Sisyphus Prime: This Will Hurt",
    ["ultrakill\\sp_yesthatsit.wav"] = "Sisyphus Prime: Yes That's It",
    ...
    ["ultrakill\\v1_hpget.wav"] = "V1: Health Pickup",
